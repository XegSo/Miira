...
module.exports = {
    ...
    async execute(int) {
        ...
        try {
            ...
            await int.reply({ content: `Ticket channel created: ${channel}`, ephemeral: true });
            ...
            await int.reply({ content: 'An error occurred while creating the ticket channel.', ephemeral: true });
        }
    },
    userTicketCache
};

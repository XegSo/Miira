...
module.exports = {
    ...
    async execute(int, client) {
        ...
        const newPremium = {
            ...
            'currentAmount': `${newAmmount}`
        };
        await localFunctions.setUserMontlyPremium(userId, newPremium, collection);
        ...
        try {
            ...
            let checkoutComponents = new ActionRowBuilder().addComponents(
                new ButtonBuilder()
                    .setLabel('💳 PayPal')
                    .setURL(`${localConstants.paypal}${newAmmount}`)
                    .setStyle('Link'),
                new ButtonBuilder()
                    .setLabel('💳 Ko-Fi')
                    .setURL(`${localConstants.kofi}${newAmmount}`)
                    .setStyle('Link'),
                new ButtonBuilder()
